...
import { MessageSquareText, WandSparkles, Cpu } from 'lucide-react';
import { TENSION_OPACITY, RELEASE_OPACITY, MOTION_DURATION, RESET_DELAY, QE_1_TRANSITION, QE_2_TRANSITION } from './constants';
  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="absolute left-[15%] top-[65%] -translate-x-1/2">
        <span className="font-mono text-[10px] uppercase tracking-[0.14em] text-gray-400">query</span>
      </div>

      <div className="absolute left-[49.6%] top-[65%] -translate-x-1/2">
        <span className="font-mono text-[10px] uppercase tracking-[0.14em] text-gray-400">Rewriter</span>
      </div>
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-5 text-center">
        <span className="font-mono text-xs tracking-wide text-gray-500">Rewrite before retrieval</span>
      </div>
    </div>
  );
}
