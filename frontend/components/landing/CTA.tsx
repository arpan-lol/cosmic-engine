    ...
    <section className="bg-white border-t border-gray-200 py-32 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center z-10 flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full max-w-sm justify-center">
          ...
          <a href="https://github.com/arpan-lol/cosmic-engine" target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2 h-14 bg-white border-2 border-gray-200 text-[#1a1a1c] rounded-md font-semibold text-lg hover:border-gray-300 hover:bg-gray-50 transition-colors">
